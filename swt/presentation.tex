...
\begin{slide}{Development Process}
  \parbox[t]{0.6\textwidth}{%
    ...
    \hspace*{5cm}
    \begin{rotate}{353}
      \includegraphics[width=\linewidth]{pics/group}
    \end{rotate}}
  \vspace*{-3.5cm}
  \begin{itemize}
    \item Xtreme Programming
...
\begin{slide}{Working the Code}
  \parbox[t]{0.6\textwidth}{%
    ...
    \hspace*{5cm}
    \begin{rotate}{0}
      \includegraphics[width=1.2\linewidth]{pics/MVC}
    \end{rotate}}
  \vspace*{-4.7cm}
  \begin{itemize}
...
\overlays{3}{%
\begin{slide}{Prospect}
  \begin{itemize}
    \item Asynchronous updates 
      \begin{itemize}
	\item Threaded updating of the feeds in the server
	\item Controller check for new Tags and Feed-Items
	  regularily
	\item AJAX for the views to show new information
      \end{itemize}
    \fromSlide{2}{%
    \item Interface polishing
      \begin{itemize}
	\item Better registration process
	\item General user interface cleanup
      \end{itemize}}
    \fromSlide{3}{%
    \item I/O Options
      \begin{itemize}
